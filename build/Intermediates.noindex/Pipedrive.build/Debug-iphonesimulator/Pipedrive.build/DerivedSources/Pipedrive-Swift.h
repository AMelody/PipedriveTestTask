...
#ifndef PIPEDRIVE_SWIFT_H
#define PIPEDRIVE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Pipedrive",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9Pipedrive11AppDelegate")
...
SWIFT_CLASS("_TtC9Pipedrive27PersonDetailsViewController")
...
@interface PersonDetailsViewController (SWIFT_EXTENSION(Pipedrive)) <UITableViewDataSource>
...
SWIFT_CLASS("_TtC9Pipedrive21PersonsViewController")
...
@interface PersonsViewController (SWIFT_EXTENSION(Pipedrive)) <UITableViewDelegate>
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end


@interface PersonsViewController (SWIFT_EXTENSION(Pipedrive)) <UITableViewDataSource>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC9Pipedrive13SceneDelegate")
